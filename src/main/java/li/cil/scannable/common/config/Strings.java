...
public final class Strings {
    ...
    public static Component energyStorage(final long stored, final long capacity) {
        final Component storedText = Component.literal(String.valueOf(stored)).withStyle(GREEN);
        final Component capacityText = Component.literal(String.valueOf(capacity)).withStyle(GREEN);
    ...
    public static Component energyUsage(final long value) {
        final Component energyText = Component.literal(String.valueOf(value)).withStyle(GREEN);
