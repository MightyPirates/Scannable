...
public final class ConfigManager {
    ...
    private static <T> void parseCollectionField(final T instance, final ForgeConfigSpec.Builder builder, final ArrayList<ConfigFieldPair<?>> values, final Field field, final ItemType annotation) throws IllegalAccessException {
    ...
    @SuppressWarnings({"rawtypes", "unchecked"})
    private static <T> void parseMapField(final T instance, final ForgeConfigSpec.Builder builder, final ArrayList<ConfigFieldPair<?>> values, final Field field, final KeyValueTypes annotation) throws IllegalAccessException {
    ...
    private static <T> void parseRegularField(final T instance, final ForgeConfigSpec.Builder builder, final ArrayList<ConfigFieldPair<?>> values, final Field field) throws IllegalAccessException {
    ...
    private static ConfigFieldPair<?> parseBooleanField(final Object instance, final Field field, final ForgeConfigSpec.Builder builder) throws IllegalAccessException {
        final boolean defaultValue = field.getBoolean(instance);

        final ForgeConfigSpec.BooleanValue configValue = withCommonAttributes(field, builder)
                .define(getPath(field), defaultValue);

        return new SetFieldConfigItem<>(field, configValue);
    }

    private static ConfigFieldPair<?> parseIntField(final Object instance, final Field field, final ForgeConfigSpec.Builder builder) throws IllegalAccessException {
        ...
        final var configValue = withCommonAttributes(field, builder)
                .defineInRange(getPath(field), defaultValue, minValue, maxValue);

        return new SetFieldConfigItem<>(field, configValue);
    }

    private static ConfigFieldPair<?> parseLongField(final Object instance, final Field field, final ForgeConfigSpec.Builder builder) throws IllegalAccessException {
    ...
    private static ConfigFieldPair<?> parseDoubleField(final Object instance, final Field field, final ForgeConfigSpec.Builder builder) throws IllegalAccessException {
    ...
    private static ConfigFieldPair<?> parseStringLikeField(final Object instance, final Field field, final ForgeConfigSpec.Builder builder, final Pair<Function<Object, String>, Function<String, Object>> defaultSerializers) throws IllegalAccessException {
    ...
    private static ForgeConfigSpec.Builder withCommonAttributes(final Field field, final ForgeConfigSpec.Builder builder) {
    ...
    private interface ConfigFieldParser {
        ConfigFieldPair<?> apply(final Object instance, final Field field, final ForgeConfigSpec.Builder builder) throws IllegalAccessException;
    }
    ...
    private static abstract class ConfigFieldPair<T> {
    ...
    private static final class SetFieldConfigItem<T> extends ConfigFieldPair<T> {
        ...
        public SetFieldConfigItem(final Field field, final ForgeConfigSpec.ConfigValue<T> value, final Function<T, Object> converter) {
            super(field, value);
            this.converter = converter;
        }

        public SetFieldConfigItem(final Field field, final ForgeConfigSpec.ConfigValue<T> value) {
    ...
    private static final class ApplyFieldConfigItem<T> extends ConfigFieldPair<T> {
        ...
        public ApplyFieldConfigItem(final Field field, final ForgeConfigSpec.ConfigValue<T> value, final Consumer<T> applier) {
            super(field, value);
