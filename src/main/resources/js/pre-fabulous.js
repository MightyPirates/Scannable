        ...
        "Render Scan Effect": {
            ...
            "transformer": function(methodNode) {
                ASMAPI.insertInsnList(methodNode,
                    ...
                    // INVOKEVIRTUAL net/minecraft/client/renderer/OutlineLayerBuffer.finish ()V
                    ASMAPI.MethodType.VIRTUAL, "net/minecraft/client/renderer/OutlineLayerBuffer", "finish", "()V",
